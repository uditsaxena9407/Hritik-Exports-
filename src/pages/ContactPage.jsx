  ...
  return (
    ...
    >
      ...
      <div>
        <textarea
          rows={5}
          placeholder="Your Message (min 50 kg order)"
          value={form.message}
    ...
    <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 pt-24 overflow-hidden">
        ...
        <div className="relative z-10 grid md:grid-cols-2 gap-10 items-center p-10 lg:p-20 text-white">
          <motion.div initial={{ x: -100, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.9 }}>
            ...
            <p className="mt-6 text-lg max-w-lg">
              Ready to ship export‑grade potatoes? Minimum order: <strong>50 kg</strong>. Response within <strong>2 hours</strong>.
            </p>
      ...
      <section className="grid md:grid-cols-2 gap-12 mb-20">
        <div className="space-y-6">
          ...
          <p className="text-sm text-gray-500">Minimum order: <span className="font-bold text-green-700">50 kg</span></p>
        </div>
